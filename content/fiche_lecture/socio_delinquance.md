...
Cette une époque ou il y a beaucoup d'immigré en USA et il existe une notion commune disant que l'individu et formé par sa culture.

La culture est définie comme un système de valeurs qui peut être supérieur au cadre juridique.
...
- **Conformisme**: Assure la continuité de la société.
- **Innovation**: Le but ou succès est supérieur aux moyens, donc prêt à tout, ce qui inclut la criminalité en col blanc et la criminalité de la classe très inférieur.
- **Ritualisme**: On se désintéresse du but et de l'idéal partagé, mais on garde les habitudes. Plus répandu dans la classe moyenne inférieure.
- **Évasion**: Le plus rare, ces individus ne partagent pas les valeurs communes et sortent complètement des normes, ce sont les déviants complets.
- **Rébellion**: Rejet des normes par les membres et rejet des membres par la société, souvent caractérisé par un caractère révolutionnaire.

L'éducation est perçue comme un moyen d'obtenir un emploi, et non simplement pour l'acquisition de connaissances. Le rêve américain construit cette notion de même chance pour tous. Cela créé une compétition acharnée, un individualisme et une réussite personnelle qui "contamine" les autres pans de la société.

#### Critiques

- Il est erroné de croire que tout le monde en Occident a les mêmes buts.
- Explique la délinquance des riches prêts à tout pour être encore plus riches, mais pas celle des pauvres.
- La délinquance des jeunes n'est pas motivée par la richesse mais est une réaction à l'injustice.

Les jeunes en situation de pauvreté sont en forte tension avec le reste de la société. Désapprouvés par la société, ils vont se regrouper entre eux, créant ainsi une sous-culture.

La théorie des opportunités différentielles dis que devenir délinquant est une opportunité pour répondre à la désorganisation sociale et à l'assignation à une place. Il existe trois formes de sous-cultures illégitimes:

1. **Criminelle**: Socialisation dans la délinquance à travers les plus âgés, signe de réussite sociale.
...
Le lien social empêche de commettre des crimes :

- **Attachement** : Identification aux pairs et sensibilité aux opinions des autres.
- **Engagement** : Plus on est investi dans un milieu, plus il est difficile d'en sortir.
- **Implication** : Tellement engagé qu'on n'a pas le temps de faire autre chose.
- **Croyance** : En la valeur des normes.

Reproches : oubli du conflit et incohérence avec les théories culturalistes.
...
L'évolution des années 50 a fortement modifié les routines et les structures, il a été vu entre 1947 et 1977:

- Une augmentation du célibat
- Des déplacements plus longs
- plus de femmes au travail
- Plus de départs en vacances
- Beaucoup plus biens en circulation

Tout cela peut être mis en lien avec la forte augmentation des cambriolages.
